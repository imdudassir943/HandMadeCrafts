...
def seed():
    ...
    products_data = [
        {
            ...
            "description_ur": "ہر مٹی کا گلدان مقامی طور پر حاصل کردہ مٹی سے روایتی چاک پر ہاتھ سے تیار کیا جاتا ہے۔ اسے بلند درجہ حرارت پر پکا کر ایک منفرد معدنی چمک کے ساتھ مکمل کیا جاتا ہے، جس سے اس کی بناوٹ اور رنگ میں ایسی باریک تبدیلیاں آتی ہیں جو ہر ٹکڑے کو ایک منفرد فن پارہ بناتی ہیں۔",
        ...
        },
        {
            ...
            "price": 120.00,
            "image": "products/wall_hanging.png",
        ...
        },
        {
            ...
            "price": 150.00,
            "image": "products/brass_lantern.png",
    ...
    reviews_data = [
        ...
        },
        {
            ...
            "comment_ur": "زیتون کی لکڑی کا یہ پیالہ بہت شاندار ہے۔ اس کی خوشبو اور بناوٹ قدرتی احساس دیتی ہے۔ یہ سائز میں تھوڑا چھوٹا ہے لیکن میرے کھانے کی میز پر بہت جچتا ہے۔"
        }
    ]

    for rev_data in reviews_data:
        Review.objects.get_or_create(
            product=rev_data['product'],
